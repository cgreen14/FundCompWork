...
using namespace std;
  ...
  void ship::drawship(float rd,bool flame){  // takes in angle and flame
    ...
    XPoint mypts[] = { {xposition+20*cos(rad2-M_PI/6),yposition-20*sin(rad2-M_PI/6)},{xposition-20*cos(rd+M_PI/6),yposition+20*sin(rd+M_PI/6)},{xposition-fire*cos(rad3),yposition-fire*sin(rad3)}};
